...
public class MoveSnakePrefab : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (period > 0.5)
        {
            ...
            {
                if (direction == "right")//go to right
                {
    ...
    private void GoDown()
    {
        ...
        else if (direction == "left")// change direction 
        {
    ...
    void OnTriggerEnter2D(Collider2D o)
    {
        ...
        if (o.gameObject.tag == "mushroom")
        {
            ...
            if (goDown == 0)// need to go down 
            {
                ifDown = true;
            }                    

        }
        else if (o.gameObject.tag == "wall")// if game object collide with wall
        {
        ...
        else if (o.gameObject.tag == "bullet")// if game object collide with bullet
        {
            Debug.Log("bullet");
            ...
            if (IsCentipadeDie())//is Centipade  die
            {
                //Game over
        ...
        else if (o.gameObject.tag == "bottom")// if game object collide with bottom
        {
            //  if (!ScoreWindow.RemoveLife()) // if there are no lifes
               //Game over
                Debug.Log("Game over");
                Time.timeScale = 0f;
        ...
        else if (o.gameObject.tag == "player") // if game object collide with player
        {
            //  if (!ScoreWindow.RemoveLife())// if there are no lifes
            //Game over
            Debug.Log("Game over");
